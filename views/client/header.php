    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                        ...
                        <li class="lvl1 parent megamenu"><a href="#">Sản phẩm <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        <li class="lvl1 parent megamenu"><a href="#">Về chúng tôi <i class="anm anm-angle-down-l"></i></a>
                        </li>
                        <li class="lvl1"><a href="#"><b>Mua ngay!</b> <i class="anm anm-angle-down-l"></i></a>
                        </li>
                    </ul>
                </nav>
                <!--End Desktop Menu-->
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                <div class="logo">
                    <a href="index.html">
                        <img src="/assets/client/images/logo.svg" alt="Pet shop" title="Pet shop" />
                    </a>
                </div>
            </div>
            <!--Mobile Logo-->
